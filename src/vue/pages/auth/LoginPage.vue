  ...
  <q-page class="flex flex-center">
    <q-card class="q-pa-md shadow-2 login-card">
      ...
      <q-card-section>
        ...
        <q-input v-model="password" label="Password" type="password" filled dense class="q-mb-md" />

        <q-btn label="Login" color="primary" class="full-width q-mt-md" :loading="loading" @click="login" />

        <q-btn flat dense class="full-width q-mt-sm" to="/register" label="Don't have an account? Register" />
      </q-card-section>
    </q-card>
  </q-page>
</template>
